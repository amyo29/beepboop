...
class AlarmRequestTableViewCell: UITableViewCell {

    @IBOutlet weak var alarmImageView: UIImageView!
    @IBOutlet weak var alarmNameLabel: UILabel!
    @IBOutlet weak var alarmFriendLabel: UILabel!
    @IBOutlet weak var alarmTimeLabel: UILabel!
    @IBOutlet weak var alarmDateLabel: UILabel!
    @IBOutlet weak var alarmAcceptButton: UIButton!
    @IBOutlet weak var alarmDenyButton: UIButton!
