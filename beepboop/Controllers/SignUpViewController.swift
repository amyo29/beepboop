    ...
    @IBAction func signUpButtonPressed(_ sender: Any) {
        ...
        Auth.auth().createUser(withEmail: email, password: password) {
            ...
            if error == nil, let user = user {
                ...
                let newUser = UserCustom(userId: user.user.uid, userEmail: email, alarmData: nil, snoozeEnabled: false, darkModeEnabled: false, friendRequestsReceived: nil, friendRequestsSent: nil, alarmRequestsReceived: nil, alarmRequestsSent: nil, notifications: nil)
